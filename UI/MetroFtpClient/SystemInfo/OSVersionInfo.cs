...
namespace MetroFtpClient.SystemInfo
{
    public static class OSVersionInfo
    {
        ...
        static public string OsVersionCompleteString
        {
            get
            {
                var servicePack = (ServicePack != string.Empty) ? " (" + ServicePack + ")" : string.Empty;
                var osBit = (OSBits == SoftwareArchitecture.Bit32) ? "32 Bit" : "64 Bit";
                return Name +
                         " " +
                         Edition +
                         " " +
