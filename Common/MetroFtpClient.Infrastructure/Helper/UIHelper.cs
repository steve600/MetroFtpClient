...
namespace MetroFtpClient.Infrastructure.Helper
{
    /// <summary>
    /// Visual Tree helper class (taken from here: https://rachel53461.wordpress.com/2011/10/09/navigating-wpfs-visual-tree/)
    /// </summary>
    /// <example>
    /// Search up the VisualTree to find DataGrid containing specific Cell <see cref="FindChild{T}(DependencyObject)"/>
    /// <code>
    /// var parent = VisualTreeHelpers.FindAncestor<DataGrid>(myDataGridCell);
    /// </code>
    /// Search down the VisualTree to find a CheckBox in this DataGridCell <see cref="FindChild{T}(DependencyObject)"/>
    /// <code>
    /// var child = VisualTreeHelpers.FindChild<CheckBox>(myDataGridCell);
    /// </code>
    /// Search up the VisualTree to find a TextBox named SearchTextBox <see cref="FindAncestor{T}(DependencyObject, string)"/>
    /// <code>
    /// var searchBox = VisualTreeHelpers.FindAncestor<TextBox>(myDataGridCell, "SeachTextBox");
    /// </code>
    /// Search down the VisualTree to find a Label named MyCheckBoxLabel <see cref="FindChild{T}(DependencyObject, string)"/>
    /// <code>
